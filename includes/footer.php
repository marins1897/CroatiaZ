<?php if (isset($_SESSION['user']['username'])) { ?>
	<div class="logged_in_info">
		<span>Dobrodošao  <?php echo $_SESSION['user']['username'] ?></span>
		|
	...
	<div class="footer">
		...
		<div class="login_div" >
			<form action="<?php echo BASE_URL . 'index.php'; ?>" method="post" >
				...
				<button class="btn" type="submit" name="login_btn">Prijavi se</button>
				<a href="register.php" ><button class="btn">Join!</button></a>
			</form>
		</div>
		</div>
	<!--kraj logiranja -->
